  ...
  return (
    <>
      <div className='card-content'>
        <div className='bg-palette-sunset overflow-hidden w-2/5 mt-20 m-auto items-center rounded-md'>
          <form className='card flex flex-col m-auto items-center'>
            ...
            />
            <h3 className='profile-name my-3 text-xl font-medium text-palette-cloud'>Bette Random</h3>
            <input
